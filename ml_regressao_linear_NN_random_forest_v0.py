...
def main():
    ...
    if run_analysis or symbol:
        ...
        if show_forecasts:
            ...
            # Risk disclaimer
            st.warning("⚠️ **Disclaimer**: These forecasts are for educational purposes only and should not be considered as financial advice. Stock prices are highly volatile and unpredictable.")
